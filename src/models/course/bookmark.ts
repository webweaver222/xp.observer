...
import { IBookmark, IBookmarkDocument, IBookmarkModel } from './interfaces/bookmark'
...
schema.statics.getByEpisode = async function getByEpisode(episodeId: ObjectId, userId: ObjectId) {
 ...
 */
const Bookmark: IBookmarkModel = model<IBookmarkDocument, IBookmarkModel>(MONGO_COLLECTIONS.Bookmarks, schema)
